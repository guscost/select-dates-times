...
var R = function (e, t, n) {
      ...
      o = H(t)
        ? (function (a, s) {
            for (var l = 0; l < a.length; l++)
              if (a[l].identifier === s) return a[l];
            return a[0];
          })(t.touches, n)
        : t;
    return {
      left: R((o.pageX - (r.left + V(e).pageXOffset)) / r.width),
      top: R((o.pageY - (r.top + V(e).pageYOffset)) / r.height),
    };
  },
  ne = function (e) {
    ...
    var t = e.onMove,
      ...
      i = m.useMemo(
        function () {
          var x = function (p) {
              ne(p),
                (H(p) ? p.touches.length > 0 : p.buttons > 0) && o.current
                  ? a(te(o.current, p, l.current))
                  : M(!1);
            },
            j = function () {
              return M(!1);
          ...
          function M(p) {
            var b = c.current,
              w = V(o.current),
              E = p ? w.addEventListener : w.removeEventListener;
            E(b ? "touchmove" : "mousemove", x),
              E(b ? "touchend" : "mouseup", j);
          }
          return [
            function (p) {
              var b = p.nativeEvent,
              ...
              if (
                ...
                w.focus(), a(te(w, b, l.current)), M(!0);
              }
            },
            function (p) {
              var b = p.which || p.keyCode;
              b < 37 ||
                b > 40 ||
                (p.preventDefault(),
                s({
  ...
  Z = function (e) {
    var t = e.color,
      ...
      r = e.top,
      o = r === void 0 ? 0.5 : r,
      a = T(["react-colorful__pointer", e.className]);
  ...
  Se = { grad: 0.9, turn: 360, rad: 360 / (2 * Math.PI) },
  Re = function (e) {
    return ge(A(e));
  },
  A = function (e) {
    return (
      ...
      e.length < 6
        ? {
            ...
            a: e.length === 4 ? y(parseInt(e[3] + e[3], 16) / 255, 2) : 1,
          }
        : {
            r: parseInt(e.substring(0, 2), 16),
            g: parseInt(e.substring(2, 4), 16),
            b: parseInt(e.substring(4, 6), 16),
            a: e.length === 8 ? y(parseInt(e.substring(6, 8), 16) / 255, 2) : 1,
          }
    );
  },
  je = function (e, t) {
    return t === void 0 && (t = "deg"), Number(e) * (Se[t] || 1);
  },
  ze = function (e) {
    var t =
  ...
  de = function (e) {
    ...
    var a = Math.floor(t),
      ...
      i = a % 6;
    return {
      r: y(255 * [r, l, s, s, c, r][i]),
      g: y(255 * [c, r, r, l, s, s][i]),
      b: y(255 * [s, s, c, r, r, l][i]),
      a: y(o, 2),
    };
  },
  Te = function (e) {
  ...
  me = h.memo(function (e) {
    var t = e.hue,
      n = e.onChange,
      r = T(["react-colorful__hue", e.className]);
    return h.createElement(
      "div",
      { className: r },
      h.createElement(
        ...
        h.createElement(Z, {
          ...
          left: t / 360,
          color: G({ h: t, s: 100, v: 100, a: 1 }),
        }),
      ),
    );
  }),
  be = h.memo(function (e) {
    var t = e.hsva,
      n = e.onChange,
      r = { backgroundColor: G({ h: t.h, s: 100, v: 100, a: 1 }) };
    return h.createElement(
      "div",
      ...
      h.createElement(
        Q,
        {
          ...
          "aria-label": "Color",
          "aria-valuetext":
            "Saturation " + y(t.s) + "%, Brightness " + y(t.v) + "%",
        },
        h.createElement(Z, {
  ...
  Le = function (e, t) {
    return e.toLowerCase() === t.toLowerCase() || ve(A(e), A(t));
  };
function ye(e, t, n) {
  var r = K(n),
    ...
    a = o[0],
    s = o[1],
    l = m.useRef({ color: t, hsva: a });
  m.useEffect(
    function () {
      if (!e.equal(t, l.current.color)) {
        var i = e.toHsva(t);
        (l.current = { hsva: i, color: t }), s(i);
      }
    },
    [t, e],
  ),
    m.useEffect(
      function () {
        var i;
        ve(a, l.current.hsva) ||
          e.equal((i = e.fromHsva(a)), l.current.color) ||
          ((l.current = { hsva: a, color: i }), r(i));
      },
      [a, e, r],
    );
  var c = m.useCallback(function (i) {
    s(function (d) {
...
var qe = typeof window < "u" ? m.useLayoutEffect : m.useEffect,
  Be = function () {
  ...
  Xe = function (e) {
    var t = e.className,
      ...
      a = e.onChange,
      s = J(e, ["className", "colorModel", "color", "onChange"]),
      l = m.useRef(null);
    xe(l);
    var c = ye(n, o, a),
      i = c[0],
      d = c[1],
      f = T(["react-colorful", t]);
    return h.createElement(
      "div",
      I({}, s, { ref: l, className: f }),
      h.createElement(be, { hsva: i, onChange: d }),
      h.createElement(me, {
        hue: i.h,
        onChange: d,
  ...
  De = {
    ...
    toHsva: Re,
    fromHsva: function (e) {
      return Fe({ h: e.h, s: e.s, v: e.v, a: 1 });
    },
    equal: Le,
  },
  We = function (e) {
    return h.createElement(Xe, I({}, e, { colorModel: De }));
  },
  Ke = function (e) {
    var t = e.className,
      n = e.hsva,
      ...
      o = {
        backgroundImage:
          ...
          B(Object.assign({}, n, { a: 0 })) +
          ", " +
          B(Object.assign({}, n, { a: 1 })) +
          ")",
      },
      a = T(["react-colorful__alpha", t]),
      s = y(100 * n.a);
    return h.createElement(
      "div",
      { className: a },
  ...
  we = function (e) {
    ...
    return h.createElement(
      ...
      I({}, s, { ref: l, className: f }),
      h.createElement(be, { hsva: i, onChange: d }),
      h.createElement(me, { hue: i.h, onChange: d }),
      h.createElement(Ke, {
        hsva: i,
        onChange: d,
        className: "react-colorful__last-control",
  ...
  Ae = function (e) {
    return h.createElement(we, I({}, e, { colorModel: Ve }));
  },
  Ge = {
  ...
  Ue = function (e) {
    return h.createElement(we, I({}, e, { colorModel: Ge }));
  },
  Ye = {
...
const F = Ye,
  ke = {};
for (const e of Object.keys(F)) ke[F[e]] = e;
const u = {
...
u.rgb.hsl = function (e) {
  ...
  const i = (o + a) / 2;
  return (
    a === o ? (c = 0) : i <= 0.5 ? (c = s / (a + o)) : (c = s / (2 - a - o)),
    [l, c * 100, i * 100]
  );
};
  ...
  for (t[e].distance = 0; n.length; ) {
    ...
    for (let a = o.length, s = 0; s < a; s++) {
      const l = o[s],
        c = t[l];
      c.distance === -1 &&
        ((c.distance = t[r].distance + 1), (c.parent = r), n.unshift(l));
    }
  }
  return t;
}
...
function tt(e, t) {
  ...
  let r = X[t[e].parent][e],
    o = t[e].parent;
  for (; t[o].parent; )
    n.unshift(t[o].parent), (r = et(X[t[o].parent][o], r)), (o = t[o].parent);
...
ot.forEach((e) => {
  (N[e] = {}),
    Object.defineProperty(N[e], "channels", { value: U[e].channels }),
    Object.defineProperty(N[e], "labels", { value: U[e].labels });
  const t = rt(e);
  Object.keys(t).forEach((r) => {
    const o = t[r];
    (N[e][r] = st(o)), (N[e][r].raw = at(o));
  });
});
var lt = N;
const _ = ue(lt);
...
var dt = ht,
  ...
  mt = /^\s+/;
function bt(e) {
  return e && e.slice(0, gt(e) + 1).replace(mt, "");
}
var vt = bt,
  pt = vt,
  oe = fe,
...
function Et(e) {
  ...
  e = pt(e);
  var n = wt.test(e);
  return n || kt.test(e) ? _t(e.slice(2), n ? 2 : 8) : xt.test(e) ? ae : +e;
}
var Mt = Et,
  Ct = fe,
  W = ut,
...
function Nt(e, t, n) {
  ...
  (t = se(t) || 0),
    Ct(n) &&
      ((d = !!n.leading),
      (f = "maxWait" in n),
      (a = f ? Ot(se(n.maxWait) || 0, t) : a),
      (g = "trailing" in n ? !!n.trailing : g));
  function x(v) {
    var C = r,
      z = o;
    return (r = o = void 0), (i = v), (s = e.apply(z, C)), s;
  }
  function j(v) {
    return (i = v), (l = setTimeout(b, t)), d ? x(v) : s;
  }
  function M(v) {
    var C = v - c,
      z = v - i,
      ee = t - C;
    return f ? It(ee, a - z) : ee;
  }
  function p(v) {
    var C = v - c,
      z = v - i;
    return c === void 0 || C >= t || C < 0 || (f && z >= a);
  }
  function b() {
    var v = W();
    if (p(v)) return w(v);
  ...
  function w(v) {
    return (l = void 0), g && r ? x(v) : ((r = o = void 0), s);
  }
  function E() {
    l !== void 0 && clearTimeout(l), (i = 0), (r = c = o = l = void 0);
  }
  function k() {
    return l === void 0 ? s : w(W());
  }
  function O() {
    var v = W(),
      C = p(v);
    if (((r = arguments), (o = this), (c = v), C)) {
      if (l === void 0) return j(c);
      if (f) return clearTimeout(l), (l = setTimeout(b, t)), x(c);
    }
    return l === void 0 && (l = setTimeout(b, t)), s;
  }
  return (O.cancel = E), (O.flush = k), O;
}
var St = Nt;
const Rt = ue(St);
var jt = $.div({
  ...
  Ft = $(Ce)(({ theme: e }) => ({ fontFamily: e.typography.fonts.base })),
  Tt = $.div({
    display: "grid",
  ...
  Lt = `url('data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity=".05"><path d="M8 0h8v8H8zM0 8h8v8H0z"/></svg>')`,
  le = ({ value: e, style: t, ...n }) => {
    let r = `linear-gradient(${e}, ${e}), ${Lt}, linear-gradient(#fff, #fff)`;
    return h.createElement(Pt, { ...n, style: { ...t, backgroundImage: r } });
  },
  qt = $($e.Input)(({ theme: e, readOnly: t }) => ({
    width: "100%",
    paddingLeft: 30,
    paddingRight: 30,
  ...
  Ee = ((e) => ((e.RGB = "rgb"), (e.HSL = "hsl"), (e.HEX = "hex"), e))(
    Ee || {},
  ),
  L = Object.values(Ee),
  Xt = /\(([0-9]+),\s*([0-9]+)%?,\s*([0-9]+)%?,?\s*([0-9.]+)?\)/,
  Dt = /^\s*rgba?\(([0-9]+),\s*([0-9]+),\s*([0-9]+),?\s*([0-9.]+)?\)\s*$/i,
  Wt = /^\s*hsla?\(([0-9]+),\s*([0-9]+)%,\s*([0-9]+)%,?\s*([0-9.]+)?\)\s*$/i,
  Y = /^\s*#?([0-9a-f]{3}|[0-9a-f]{6})\s*$/i,
  Kt = /^\s*#?([0-9a-f]{3})\s*$/i,
  Vt = { hex: We, rgb: Ue, hsl: Ae },
  q = {
    hex: "transparent",
    rgb: "rgba(0, 0, 0, 0)",
    hsl: "hsla(0, 0%, 0%, 0)",
  ...
  ce = (e) => {
    let t = e == null ? void 0 : e.match(Xt);
    if (!t) return [0, 0, 0, 1];
    let [, n, r, o, a = 1] = t;
  ...
  S = (e) => {
    ...
    if (Dt.test(e)) {
      let [s, l, c, i] = ce(e),
        [d, f, g] = _.rgb.hsl([s, l, c]) || [0, 0, 0];
      return {
        valid: t,
        value: e,
        keyword: _.rgb.keyword([s, l, c]),
        colorSpace: "rgb",
        rgb: e,
        hsl: `hsla(${d}, ${f}%, ${g}%, ${i})`,
        hex: `#${_.rgb.hex([s, l, c]).toLowerCase()}`,
      };
    }
    if (Wt.test(e)) {
      let [s, l, c, i] = ce(e),
        [d, f, g] = _.hsl.rgb([s, l, c]) || [0, 0, 0];
      return {
        valid: t,
        value: e,
        keyword: _.hsl.keyword([s, l, c]),
        colorSpace: "hsl",
        rgb: `rgba(${d}, ${f}, ${g}, ${i})`,
        hsl: e,
        hex: `#${_.hsl.hex([s, l, c]).toLowerCase()}`,
      };
    }
    let n = e.replace("#", ""),
      r = _.keyword.rgb(n) || _.hex.rgb(n),
      o = _.rgb.hsl(r),
      a = e;
    if (
      (/[^#a-f0-9]/i.test(e) ? (a = n) : Y.test(e) && (a = `#${n}`),
      a.startsWith("#"))
    )
      t = Y.test(a);
    else
  ...
  At = (e, t, n) => {
    if (!e || !(t != null && t.valid)) return q[n];
    if (n !== "hex") return (t == null ? void 0 : t[n]) || q[n];
    if (!t.hex.startsWith("#"))
      try {
        return `#${_.keyword.hex(t.hex)}`;
      } catch {
        return q.hex;
      }
    let r = t.hex.match(Kt);
    if (!r) return Y.test(t.hex) ? t.hex : q.hex;
    let [o, a, s] = r[1].split("");
    return `#${o}${o}${a}${a}${s}${s}`;
  },
  Gt = (e, t) => {
    let [n, r] = m.useState(e || ""),
      [o, a] = m.useState(() => S(n)),
      [s, l] = m.useState((o == null ? void 0 : o.colorSpace) || "hex");
    m.useEffect(() => {
      let f = e || "",
        g = S(f);
      r(f), a(g), l((g == null ? void 0 : g.colorSpace) || "hex");
    }, [e]);
    let c = m.useMemo(() => At(n, o, s).toLowerCase(), [n, o, s]),
      i = m.useCallback(
        (f) => {
          let g = S(f),
            x = (g == null ? void 0 : g.value) || f || "";
          r(x),
            x === "" && (a(void 0), t(void 0)),
            g && (a(g), l(g.colorSpace), t(g.value));
        },
        [t],
      ),
      d = m.useCallback(() => {
        let f = L.indexOf(s) + 1;
        f >= L.length && (f = 0), l(L[f]);
        let g = (o == null ? void 0 : o[L[f]]) || "";
        r(g), t(g);
      }, [o, s, t]);
    return {
      value: n,
  ...
  D = (e) => e.replace(/\s*/, "").toLowerCase(),
  Ut = (e, t, n) => {
    let [r, o] = m.useState(t != null && t.valid ? [t] : []);
    m.useEffect(() => {
      t === void 0 && o([]);
    }, [t]);
    let a = m.useMemo(
      ...
      s = m.useCallback(
        (l) => {
          l != null &&
            l.valid &&
            (a.some((c) => D(c[n]) === D(l[n])) || o((c) => c.concat(l)));
        },
        [n, a],
      );
  ...
  Yt = ({
    ...
    var E;
    let c = m.useCallback(Rt(n, 200), [n]),
      {
        value: i,
        realValue: d,
        updateValue: f,
      ...
      { presets: M, addPreset: p } = Ut(a, g, x),
      b = Vt[x],
      w = !!((E = l == null ? void 0 : l.table) != null && E.readonly);
    return h.createElement(
      jt,
      { "aria-readonly": w },
      h.createElement(
                ...
                M.map((k, O) =>
                  h.createElement(
                    ie,
                    {
                      key: `${k.value}-${O}`,
                      hasChrome: !1,
                      tooltip: h.createElement(Ft, {
                        note: k.keyword || k.value,
                      }),
                    },
                    h.createElement(le, {
                      value: k[x],
                      active: g && D(k[x]) === D(g[x]),
                      onClick: () => f(k.value),
                    }),
                  ),
                ),
        ...
        h.createElement(le, { value: d, style: { margin: 4 } }),
      ),
      h.createElement(qt, {
        id: Ie(e),
        value: i,
      ...
      i ? h.createElement(Bt, { onClick: j }) : null,
    );
  },
  ln = Yt;
export { Yt as ColorControl, ln as default };
