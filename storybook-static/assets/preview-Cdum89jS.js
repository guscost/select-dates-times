...
function Z() {
  ...
  h.canvas &&
    (H(),
    (e = h.canvas.parentNode) == null || e.removeChild(h.canvas),
    (h = {}));
}
var w = {
    margin: "#f6b26b",
...
function J(e, { padding: t, border: o, width: l, height: i, top: n, left: r }) {
...
function Q(e, t, { margin: o, border: l, padding: i }, n, r) {
  let f = (m) => 0,
    a = 0,
    s = 0,
    u = r ? 1 : 0.5,
...
function et(e, t, { type: o, position: l = "center", text: i }, n, r = !1) {
  let { x: f, y: a } = J(l, t),
    { offsetX: s, offsetY: u } = Q(o, l, t, c + 1, r);
  (f += s), (a += u);
  let { w: g, h: m } = C(e, i);
  if (n && x({ x: f, y: a, w: g, h: m }, n)) {
    let v = tt(l, { x: f, y: a, w: g, h: m }, n);
    (f = v.x), (a = v.y);
  }
  return X(e, o, { x: f, y: a, w: g, h: m }, i);
}
function ot(e, { w: t, h: o }) {
  let l = t * 0.5 + c,
    i = o * 0.5 + c;
  return {
...
function it(e, t, { type: o, text: l }) {
  let { floatingAlignment: i, extremities: n } = t,
    r = n[i.x],
    f = n[i.y],
    { w: a, h: s } = C(e, l),
    { offsetX: u, offsetY: g } = ot(i, { w: a, h: s });
...
function E(e, t, o, l) {
  ...
  o.forEach((n, r) => {
    let f =
      l && n.position === "center" ? it(e, t, n) : et(e, t, n, i[r - 1], l);
    i[r] = f;
  });
}
function lt(e, t, o, l) {
      ...
      T(() => {
        ...
        return (
          t.viewMode === "story" &&
            ...
            R(M.x, M.y)),
          () => {
            window.removeEventListener("resize", i), Z();
          }
        );
      }, [o, t.viewMode]),
      e()
